...
class TextDocumentServices {
    uploadNewTextDocument(filename, filecontent) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newDocument = new Documents_1.default({
                filename: filename,
    ...
    getSpecificDocument(filename) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield Documents_1.default.findOne({ filename });
        });
    }
    getAllDocuments() {
        return __awaiter(this, void 0, void 0, function* () {
            let allDocuments = [];
            allDocuments = yield Documents_1.default.find();
            return allDocuments;
        });
    }
    deleteSpecificDocument(filename) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield Documents_1.default.findOneAndDelete({ filename });
        });
    }
}
